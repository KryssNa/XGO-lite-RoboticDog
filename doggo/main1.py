...
def run_sheru_block():
    """
    Execute the Sheru block functionality.
    Replace "sheruScript.py" with the actual filename or path of your Sheru script.
    """
    print("Running Sheru block")
    os.system("python3 sheruScript.py")
...
def main_program():
    ...
    if current_selection==1:
        ...
        draw.line((210,188,210,240),fill=txt_unselected,width=1,joint=None)
        draw.rectangle((0,188,320,240),outline=txt_unselected,width=1)
    elif current_selection == 4:  # New option: Sheru
        lcd_rect(0,188,320,240,color=btn_unselected,thickness=-1)
        lcd_rect(210, 188, 320, 240, color=btn_selected, thickness=-1)  # Highlight "Sheru"
        lcd_draw_string(draw, 250, 195, la['MAIN']['SHERU'], color=color_white, scale=font2)
        draw.line((210, 188, 210, 240), fill=txt_unselected, width=1, joint=None)
        draw.rectangle((0, 188, 320, 240), outline=txt_unselected, width=1)
        draw.rectangle((0,188,320,240),outline=txt_unselected,width=1)
    ...
    if key_state_down == 1:
        ...
        if current_selection == 3: 
            ...
            print("Running Sheru script")
            os.system("python3 /home/pi/dog/sheru_script.py")
